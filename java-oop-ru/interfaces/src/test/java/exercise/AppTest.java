...
class AppTest {
    ...
    void testReversedSequence() {
        String text = "abcdef";
        ReversedSequence reversedSequence = new ReversedSequence(text);
        assertThat(reversedSequence.getCharSequence().toString()).isEqualTo("fedcba");
        assertThat(String.valueOf(reversedSequence.getCharSequence().charAt(1))).isEqualTo("e");
        assertThat(reversedSequence.getCharSequence().length()).isEqualTo(6);
        assertThat(reversedSequence.getCharSequence().subSequence(1, 4).toString()).isEqualTo("edc");
    }
    // END
}
